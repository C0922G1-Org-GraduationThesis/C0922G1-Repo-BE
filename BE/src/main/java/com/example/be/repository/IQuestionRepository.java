...
public interface IQuestionRepository extends JpaRepository<Question, Long> {
     ...
     *
     * @param questionContent, questionTopic
     */
    @Modifying
    @Transactional
    @Query(value = "insert into question(question_content, question_topic) value(:questionContent, :questionTopic)", nativeQuery = true)
